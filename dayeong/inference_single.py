...
def main(args):
    ...
    # load my model
    # TODO 1: best_model안 bin file 저장 폴더로 변경
    MODEL_NAME = f'{args.model_dir}'  # model dir.
...
if __name__ == '__main__':
    ...
    # model dir
    # /opt/ml/code/results/klue/roberta-large_klue_punct/1/checkpoint-3240
    parser.add_argument('--model_dir', type=str,
                        default="/opt/ml/code/best_model")
