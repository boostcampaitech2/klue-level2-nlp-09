...
df1["probs"] = (
    df1["probs"].apply(lambda x: to_nparray(x) * 0.2)
    + df2["probs"].apply(lambda x: to_nparray(x) * 0.2)
    + df3["probs"].apply(lambda x: to_nparray(x) * 0.2)
    + df4["probs"].apply(lambda x: to_nparray(x) * 0.2)
