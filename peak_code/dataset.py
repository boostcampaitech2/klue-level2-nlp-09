...
if __name__ == '__main__':
    ...
    tokenized_dataset, _= preprocess.tokenized_dataset(preprocess.data, tokenizer)


    # # count unk token 
    # unk_cnt= 0
    # for idx in range(len(tokenized_dataset[0])):
    #     for word in tokenized_dataset[idx].tokens:
    #         if word== '[UNK]': 
    #             print(tokenized_dataset[idx].tokens)
    #             unk_cnt+=1
