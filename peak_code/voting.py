...
dir = '/opt/ml'
path1 = f'{dir}/code/prediction/submission_fold0.csv' # 가져올 csv 파일 주소 입력 필수!
path2 = f'{dir}/code/prediction/submission_fold1.csv'
path3 = f'{dir}/code/prediction/submission_fold2.csv'
path4 = f'{dir}/code/prediction/submission_fold3.csv'
path5 = f'{dir}/code/prediction/submission_fold4.csv'


parser = argparse.ArgumentParser()

parser.add_argument('--finalcsv_dir', type=str, default = './prediction/submission_kfold_fin_re.csv', help='save_dir for each fold\'s logits csv')
...
for i in range(len(df1['probs'])):
    ...
    # df1['probs'][i] = torch.tensor(df1['probs'][i]).detach().cpu().numpy()
