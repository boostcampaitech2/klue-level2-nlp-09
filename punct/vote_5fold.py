...
dir = '/opt/ml/'
path1 = f'{dir}/Mybaseline/prediction/submission_fold0.csv' # 가져올 csv 파일 주소 입력 필수!
path2 = f'{dir}/Mybaseline/prediction/submission_fold1.csv'
path3 = f'{dir}/Mybaseline/prediction/submission_fold2.csv'
path4 = f'{dir}/Mybaseline/prediction/submission_fold3.csv'
path5 = f'{dir}/Mybaseline/prediction/submission_fold4.csv'


parser = argparse.ArgumentParser()

parser.add_argument('--final_dir', type=str, default = './prediction/submission_5fold.csv', help='save_dir for each fold\'s logits csv')
...
df1.to_csv(args.final_dir, index=False) #저장될 위치 및 이름 지정 필수!