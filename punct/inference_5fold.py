...
def main():
  ...
  for i in range(5) :
    ...
    best_state_dict= torch.load('/opt/ml/Mybaseline/best_model/'+'fold'+str(i)+'/pytorch_model.bin')
  ...
  # 아래 directory와 columns의 형태는 지켜주시기 바랍니다.
    ...
    output.to_csv('./prediction/submission_fold'+str(i)+'.csv', index=False) # 최종적으로 완성된 예측한 라벨 csv 파일 형태로 저장.
  #### 필수!! ##############################################
    print('---- Finish! ----')
