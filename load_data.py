...
def tokenized_dataset(dataset, tokenizer):
  ...
  tokenizer.add_special_tokens({"additional_special_tokens":
    ["[SUB:PER]", "[\SUB:PER]", #32000,32001
     "[SUB:ORG]", "[\SUB:ORG]", #32002,32003
     "[OBJ:PER]", "[\OBJ:PER]", #32004,32005
     "[OBJ:LOC]", "[\OBJ:LOC]", #32006,32007
     "[OBJ:POH]", "[\OBJ:POH]", #32008,32009
     "[OBJ:DAT]", "[\OBJ:DAT]", #32010,32011
     "[OBJ:NOH]", "[\OBJ:NOH]", #32012,32013
     "[OBJ:ORG]", "[\OBJ:ORG]"]}) #32014,32015
